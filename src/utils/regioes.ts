const BAIRROS_POR_REGIAO: Record<string, string[]> = {
  Anhanduizinho: [
    ...
    'Comunidade Esperança', 'Loteamento Pólo Empresarial Sul', "Residencial Joana D'Arc",
  ],
  Bandeira: [
  ...
  Centro: [
    ...
    'Cruzeiro', 'Clube Campestre Ypê', 'Vila Rosa', 'Vila Marman', 'Vila Gomes', 'Vila Célia', 'Vila Sílvia 2ª Seção', 'Coophagrande', 'Conjunto Eudes Costa', 'Vila Suíça', 'Conjunto Residencial Monte Castelo', 'Coophaban',
  ...
  Imbirussu: [
    ...
    'Santo Amaro', 'Vila Santo Amaro', 'Vila Jardim Beija-Flor', 'Parque dos Laranjais', 'Manoel Taveira', 'Vila Manoel Taveira', 'Santa Carmélia', 'Jardim Itapuã', 'Coophatrabalho', 'Vila Dr. Jair Garcia', 'Jardim Canadá', 'Vila São Marcos', 'Vila Almeida', 'Vila Almeida 1ª Seção', 'Vila Almeida 2ª Seção', 'Vila Palmira', 'Jardim Mandala', 'Residencial Sírio Libanês I', 'Residencial Sírio Libanês II', 'Jardim das Virtudes', 'Residencial Hugo Rodrigues',
  ...
  Lagoa: [
    'Bandeirantes', 'Vila Bandeirantes', 'Vila Bandeirante', 'Coophavila', 'Desmembramento Esteban Cornelas', 'Vila Jurema',
    'Taveirópolis', 'Vila Taveirópolis', 'Vila Base Aérea', 'Santos Dumont', 'Vila Belo Horizonte', 'Vila Belo Horizonte 2ª Seção',
    'Caiçara', 'Vila dos Marimbas', 'Vila Jardim Anahy', 'Vila Jardim Anahy 2ª Seção', 'Vila Maringá', 'Jardim Leblon',
    'União', 'Parque Residencial União', 'Parque Residencial União II', 'Residencial Oliveira I', 'Residencial Oliveira II', 'Residencial Oliveira III', 'Residencial Oliveira', 'Residencial das Flores', 'Parque Residencial dos Girassóis',
  ...
  Segredo: [
    'Nova Lima', 'Jardim Anache', 'Jardim Columbia', 'Loteamento Municipal Pereira Borges', 'Favela Jardim Anache', 'Jardim Vida Nova', 'Loteamento Vida Nova II', 'Loteamento Tarsila do Amaral', 'Loteamento Tarcila do Amaral', 'Loteamento Vida Nova III', 'José Prates', 'Coriolando da Silva Correa I', 'Coriolando da Silva Correa II', 'José Tavares do Couto', 'Oscar Salazar Moura da Cruz', 'Parque Iguatemi',
    ...
    'Seminário', 'Bairro Seminário', 'Jardim Seminário', 'Jardim Seminário II', 'Vila Santa Lúcia', 'Vila Jardim Maria Amélia', 'Vila Nossa Senhora da Conceição', 'Jardim Oracília', 'Vila Dalila', 'Vila Leda', 'Vila Antonieta', 'Vila São Roque', 'Vila Saraiva', 'Portal do Gramado', 'São Benedito', 'Lagoa da Cruz', 'North Park',
    'Nasser', 'Vila Nasser', 'Vila Nasser 2ª Seção', 'Santa Luzia', 'Vila Cox', 'Jardim Alto São Francisco', 'Jardim das Acácias', 'Vila Lili', 'Parque Residencial Azaléia', 'Jardim Veneza', 'Loteamento Municipal Dr. Miguel Vieira Ferreira', 'Jardim Fluminense', 'Nossa Senhora das Graças', 'Vila Nossa Senhora das Graças', 'Vila Nilza 1ª Seção', 'Vila Nilza 2ª Seção', 'Jardim Paquetá', 'Coophasul', 'Vila Nossa Senhora Aparecida', 'Vila Neuza', 'Vila Marli', 'Vila Novo Horizonte', 'Bosque da Saúde', 'São Caetano', 'Jardim Paradiso', 'Jardim Monte Alto', 'Loteamento Dona Dedé', 'Setvillage I', 'Setvillage II', 'Água Limpa Park', 'Residencial Carajás', 'Morada dos Deuses', 'Residencial Alto Tamandaré', 'Residencial Recanto do Cerrado', 'Bom Retiro', 'Residencial Tolentino', 'Jardim da Mooca',
